...
'decode_msg_event_store.client.users.CreateReq.Options'(Bin, TrUserData) ->
    'dfp_read_field_def_event_store.client.users.CreateReq.Options'(Bin, 0, 0, 0, id(<<>>, TrUserData), id(<<>>, TrUserData), id(<<>>, TrUserData), id([], TrUserData), TrUserData).
...
'decode_msg_event_store.client.users.UpdateReq.Options'(Bin, TrUserData) ->
    'dfp_read_field_def_event_store.client.users.UpdateReq.Options'(Bin, 0, 0, 0, id(<<>>, TrUserData), id(<<>>, TrUserData), id(<<>>, TrUserData), id([], TrUserData), TrUserData).
