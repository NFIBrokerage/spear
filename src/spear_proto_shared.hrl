...
-define(spear_proto_shared_gpb_version, "4.17.0").
...
-record('event_store.client.shared.UUID',
        {value                  :: {structured, spear_proto_shared:'event_store.client.shared.UUID.Structured'()} | {string, unicode:chardata()} | undefined % oneof
        }).
-endif.
