...
-export_type(['event_store.client.UUID.Structured'/0, 'event_store.client.UUID'/0, 'event_store.client.Empty'/0, 'event_store.client.StreamIdentifier'/0, 'event_store.client.AllStreamPosition'/0, 'event_store.client.WrongExpectedVersion'/0, 'event_store.client.AccessDenied'/0, 'event_store.client.StreamDeleted'/0, 'event_store.client.Timeout'/0, 'event_store.client.Unknown'/0, 'event_store.client.InvalidTransaction'/0, 'event_store.client.MaximumAppendSizeExceeded'/0, 'event_store.client.BadRequest'/0, 'google.protobuf.Empty'/0]).
-type '$msg_name'() :: 'event_store.client.UUID.Structured' | 'event_store.client.UUID' | 'event_store.client.Empty' | 'event_store.client.StreamIdentifier' | 'event_store.client.AllStreamPosition' | 'event_store.client.WrongExpectedVersion' | 'event_store.client.AccessDenied' | 'event_store.client.StreamDeleted' | 'event_store.client.Timeout' | 'event_store.client.Unknown' | 'event_store.client.InvalidTransaction' | 'event_store.client.MaximumAppendSizeExceeded' | 'event_store.client.BadRequest' | 'google.protobuf.Empty'.
-type '$msg'() :: 'event_store.client.UUID.Structured'() | 'event_store.client.UUID'() | 'event_store.client.Empty'() | 'event_store.client.StreamIdentifier'() | 'event_store.client.AllStreamPosition'() | 'event_store.client.WrongExpectedVersion'() | 'event_store.client.AccessDenied'() | 'event_store.client.StreamDeleted'() | 'event_store.client.Timeout'() | 'event_store.client.Unknown'() | 'event_store.client.InvalidTransaction'() | 'event_store.client.MaximumAppendSizeExceeded'() | 'event_store.client.BadRequest'() | 'google.protobuf.Empty'().
...
get_package_name() -> 'event_store.client'.
...
get_all_source_basenames() -> ["shared.proto", "empty.proto"].
...
%% functions.
get_all_proto_names() -> ["shared", "empty"].
