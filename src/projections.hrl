...
-ifndef(projections).
-define(projections, true).

-define(projections_gpb_version, "4.17.0").
...
-record('event_store.client.projections.CreateReq.Options',
        {mode                   :: {one_time, projections:'event_store.client.shared.Empty'()} | {transient, projections:'event_store.client.projections.CreateReq.Options.Transient'()} | {continuous, projections:'event_store.client.projections.CreateReq.Options.Continuous'()} | undefined, % oneof
...
-record('event_store.client.projections.CreateReq',
        {options = undefined    :: projections:'event_store.client.projections.CreateReq.Options'() | undefined % = 1, optional
        }).
-endif.
...
-record('event_store.client.projections.UpdateReq.Options',
        {name = []              :: unicode:chardata() | undefined, % = 1, optional
         ...
         emit_option            :: {emit_enabled, boolean() | 0 | 1} | {no_emit_options, projections:'event_store.client.shared.Empty'()} | undefined % oneof
        }).
-endif.
...
-record('event_store.client.projections.UpdateReq',
        {options = undefined    :: projections:'event_store.client.projections.UpdateReq.Options'() | undefined % = 1, optional
        }).
-endif.
...
-record('event_store.client.projections.DeleteReq',
        {options = undefined    :: projections:'event_store.client.projections.DeleteReq.Options'() | undefined % = 1, optional
        }).
-endif.
...
-record('event_store.client.projections.StatisticsReq.Options',
        {mode                   :: {name, unicode:chardata()} | {all, projections:'event_store.client.shared.Empty'()} | {transient, projections:'event_store.client.shared.Empty'()} | {continuous, projections:'event_store.client.shared.Empty'()} | {one_time, projections:'event_store.client.shared.Empty'()} | undefined % oneof
        }).
-endif.
...
-record('event_store.client.projections.StatisticsReq',
        {options = undefined    :: projections:'event_store.client.projections.StatisticsReq.Options'() | undefined % = 1, optional
        }).
-endif.
...
-record('event_store.client.projections.StatisticsResp',
        {details = undefined    :: projections:'event_store.client.projections.StatisticsResp.Details'() | undefined % = 1, optional
        }).
-endif.
...
-record('event_store.client.projections.StateReq',
        {options = undefined    :: projections:'event_store.client.projections.StateReq.Options'() | undefined % = 1, optional
        }).
-endif.
...
-record('event_store.client.projections.StateResp',
        {state = undefined      :: projections:'google.protobuf.Value'() | undefined % = 1, optional
        }).
-endif.
...
-record('event_store.client.projections.ResultReq',
        {options = undefined    :: projections:'event_store.client.projections.ResultReq.Options'() | undefined % = 1, optional
        }).
-endif.
...
-record('event_store.client.projections.ResultResp',
        {result = undefined     :: projections:'google.protobuf.Value'() | undefined % = 1, optional
        }).
-endif.
...
-record('event_store.client.projections.ResetReq',
        {options = undefined    :: projections:'event_store.client.projections.ResetReq.Options'() | undefined % = 1, optional
        }).
-endif.
...
-record('event_store.client.projections.EnableReq',
        {options = undefined    :: projections:'event_store.client.projections.EnableReq.Options'() | undefined % = 1, optional
        }).
-endif.
...
-record('event_store.client.projections.DisableReq',
        {options = undefined    :: projections:'event_store.client.projections.DisableReq.Options'() | undefined % = 1, optional
        }).
-endif.
...
-record('google.protobuf.Struct',
        {fields = []            :: [{unicode:chardata(), projections:'google.protobuf.Value'()}] | undefined % = 1
        }).
-endif.
...
-record('google.protobuf.Value',
        {kind                   :: {null_value, 'NULL_VALUE' | integer()} | {number_value, float() | integer() | infinity | '-infinity' | nan} | {string_value, unicode:chardata()} | {bool_value, boolean() | 0 | 1} | {struct_value, projections:'google.protobuf.Struct'()} | {list_value, projections:'google.protobuf.ListValue'()} | undefined % oneof
        }).
-endif.
...
-record('google.protobuf.ListValue',
        {values = []            :: [projections:'google.protobuf.Value'()] | undefined % = 1, repeated
        }).
-endif.
...
-record('event_store.client.shared.UUID',
        {value                  :: {structured, projections:'event_store.client.shared.UUID.Structured'()} | {string, unicode:chardata()} | undefined % oneof
        }).
-endif.
