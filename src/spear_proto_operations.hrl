...
-ifndef(spear_proto_operations).
-define(spear_proto_operations, true).

-define(spear_proto_operations_gpb_version, "4.18.0").
...
-record('event_store.client.operations.StartScavengeReq',
        {options = undefined    :: spear_proto_operations:'event_store.client.operations.StartScavengeReq.Options'() | undefined % = 1, optional
        }).
-endif.
...
-record('event_store.client.operations.StopScavengeReq',
        {options = undefined    :: spear_proto_operations:'event_store.client.operations.StopScavengeReq.Options'() | undefined % = 1, optional
        }).
-endif.
...
-record('event_store.client.UUID',
        {value                  :: {structured, spear_proto_operations:'event_store.client.UUID.Structured'()} | {string, unicode:chardata()} | undefined % oneof
        }).
-endif.
...
-record('event_store.client.WrongExpectedVersion',
        {current_stream_revision_option :: {current_stream_revision, non_neg_integer()} | {current_no_stream, spear_proto_operations:'google.protobuf.Empty'()} | undefined, % oneof
         expected_stream_position_option :: {expected_stream_position, non_neg_integer()} | {expected_any, spear_proto_operations:'google.protobuf.Empty'()} | {expected_stream_exists, spear_proto_operations:'google.protobuf.Empty'()} | {expected_no_stream, spear_proto_operations:'google.protobuf.Empty'()} | undefined % oneof
        }).
-endif.
...
-record('event_store.client.StreamDeleted',
        {stream_identifier = undefined :: spear_proto_operations:'event_store.client.StreamIdentifier'() | undefined % = 1, optional
        }).
-endif.
