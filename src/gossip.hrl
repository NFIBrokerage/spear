...
-define(gossip_gpb_version, "4.17.0").
...
-record('event_store.client.gossip.ClusterInfo',
        {members = []           :: [gossip:'event_store.client.gossip.MemberInfo'()] | undefined % = 1, repeated
        }).
-endif.
...
-record('event_store.client.gossip.MemberInfo',
        {instance_id = undefined :: gossip:'event_store.client.shared.UUID'() | undefined, % = 1, optional
         ...
         http_end_point = undefined :: gossip:'event_store.client.gossip.EndPoint'() | undefined % = 5, optional
        }).
-endif.
...
-record('event_store.client.shared.UUID',
        {value                  :: {structured, gossip:'event_store.client.shared.UUID.Structured'()} | {string, unicode:chardata()} | undefined % oneof
        }).
-endif.
