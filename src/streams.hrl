...
-define(streams_gpb_version, "4.17.0").
...
-record('event_store.client.streams.ReadReq.Options',
        {stream_option          :: {stream, streams:'event_store.client.streams.ReadReq.Options.StreamOptions'()} | {all, streams:'event_store.client.streams.ReadReq.Options.AllOptions'()} | undefined, % oneof
         ...
         count_option           :: {count, non_neg_integer()} | {subscription, streams:'event_store.client.streams.ReadReq.Options.SubscriptionOptions'()} | undefined, % oneof
         filter_option          :: {filter, streams:'event_store.client.streams.ReadReq.Options.FilterOptions'()} | {no_filter, streams:'event_store.client.shared.Empty'()} | undefined, % oneof
         uuid_option = undefined :: streams:'event_store.client.streams.ReadReq.Options.UUIDOption'() | undefined % = 9, optional
        }).
-endif.
...
-record('event_store.client.streams.ReadReq.Options.UUIDOption',
        {content                :: {structured, streams:'event_store.client.shared.Empty'()} | {string, streams:'event_store.client.shared.Empty'()} | undefined % oneof
        }).
-endif.
...
-record('event_store.client.streams.ReadReq.Options.FilterOptions',
        {filter                 :: {stream_identifier, streams:'event_store.client.streams.ReadReq.Options.FilterOptions.Expression'()} | {event_type, streams:'event_store.client.streams.ReadReq.Options.FilterOptions.Expression'()} | undefined, % oneof
         window                 :: {max, non_neg_integer()} | {count, streams:'event_store.client.shared.Empty'()} | undefined, % oneof
...
-record('event_store.client.streams.ReadReq.Options.AllOptions',
        {all_option             :: {position, streams:'event_store.client.streams.ReadReq.Options.Position'()} | {start, streams:'event_store.client.shared.Empty'()} | {'end', streams:'event_store.client.shared.Empty'()} | undefined % oneof
        }).
-endif.
...
-record('event_store.client.streams.ReadReq.Options.StreamOptions',
        {stream_identifier = undefined :: streams:'event_store.client.shared.StreamIdentifier'() | undefined, % = 1, optional
         revision_option        :: {revision, non_neg_integer()} | {start, streams:'event_store.client.shared.Empty'()} | {'end', streams:'event_store.client.shared.Empty'()} | undefined % oneof
        }).
-endif.
...
-record('event_store.client.streams.ReadReq',
        {options = undefined    :: streams:'event_store.client.streams.ReadReq.Options'() | undefined % = 1, optional
        }).
-endif.
...
-record('event_store.client.streams.ReadResp.ReadEvent',
        {event = undefined      :: streams:'event_store.client.streams.ReadResp.ReadEvent.RecordedEvent'() | undefined, % = 1, optional
         link = undefined       :: streams:'event_store.client.streams.ReadResp.ReadEvent.RecordedEvent'() | undefined, % = 2, optional
         position               :: {commit_position, non_neg_integer()} | {no_position, streams:'event_store.client.shared.Empty'()} | undefined % oneof
        }).
-endif.
...
-record('event_store.client.streams.ReadResp.ReadEvent.RecordedEvent',
        {id = undefined         :: streams:'event_store.client.shared.UUID'() | undefined, % = 1, optional
         stream_identifier = undefined :: streams:'event_store.client.shared.StreamIdentifier'() | undefined, % = 2, optional
...
-record('event_store.client.streams.ReadResp',
        {content                :: {event, streams:'event_store.client.streams.ReadResp.ReadEvent'()} | {confirmation, streams:'event_store.client.streams.ReadResp.SubscriptionConfirmation'()} | {checkpoint, streams:'event_store.client.streams.ReadResp.Checkpoint'()} | {stream_not_found, streams:'event_store.client.streams.ReadResp.StreamNotFound'()} | undefined % oneof
        }).
-endif.
...
-record('event_store.client.streams.AppendReq.Options',
        {stream_identifier = undefined :: streams:'event_store.client.shared.StreamIdentifier'() | undefined, % = 1, optional
         expected_stream_revision :: {revision, non_neg_integer()} | {no_stream, streams:'event_store.client.shared.Empty'()} | {any, streams:'event_store.client.shared.Empty'()} | {stream_exists, streams:'event_store.client.shared.Empty'()} | undefined % oneof
        }).
-endif.
...
-record('event_store.client.streams.AppendReq',
        {content                :: {options, streams:'event_store.client.streams.AppendReq.Options'()} | {proposed_message, streams:'event_store.client.streams.AppendReq.ProposedMessage'()} | undefined % oneof
        }).
-endif.
...
-record('event_store.client.streams.AppendResp.Success',
        {current_revision_option :: {current_revision, non_neg_integer()} | {no_stream, streams:'event_store.client.shared.Empty'()} | undefined, % oneof
         position_option        :: {position, streams:'event_store.client.streams.AppendResp.Position'()} | {no_position, streams:'event_store.client.shared.Empty'()} | undefined % oneof
        }).
-endif.
...
-record('event_store.client.streams.AppendResp.WrongExpectedVersion',
        {current_revision_option_20_6_0 :: {current_revision_20_6_0, non_neg_integer()} | {no_stream_20_6_0, streams:'event_store.client.shared.Empty'()} | undefined, % oneof
         expected_revision_option_20_6_0 :: {expected_revision_20_6_0, non_neg_integer()} | {any_20_6_0, streams:'event_store.client.shared.Empty'()} | {stream_exists_20_6_0, streams:'event_store.client.shared.Empty'()} | undefined, % oneof
         current_revision_option :: {current_revision, non_neg_integer()} | {current_no_stream, streams:'event_store.client.shared.Empty'()} | undefined, % oneof
         expected_revision_option :: {expected_revision, non_neg_integer()} | {expected_any, streams:'event_store.client.shared.Empty'()} | {expected_stream_exists, streams:'event_store.client.shared.Empty'()} | {expected_no_stream, streams:'event_store.client.shared.Empty'()} | undefined % oneof
        }).
-endif.
...
-record('event_store.client.streams.AppendResp',
        {result                 :: {success, streams:'event_store.client.streams.AppendResp.Success'()} | {wrong_expected_version, streams:'event_store.client.streams.AppendResp.WrongExpectedVersion'()} | undefined % oneof
        }).
-endif.
...
-record('event_store.client.streams.DeleteReq',
        {options = undefined    :: streams:'event_store.client.streams.DeleteReq.Options'() | undefined % = 1, optional
        }).
-endif.
...
-record('event_store.client.streams.DeleteResp',
        {position_option        :: {position, streams:'event_store.client.streams.DeleteResp.Position'()} | {no_position, streams:'event_store.client.shared.Empty'()} | undefined % oneof
        }).
-endif.
...
-record('event_store.client.streams.TombstoneReq',
        {options = undefined    :: streams:'event_store.client.streams.TombstoneReq.Options'() | undefined % = 1, optional
        }).
-endif.
...
-record('event_store.client.streams.TombstoneResp',
        {position_option        :: {position, streams:'event_store.client.streams.TombstoneResp.Position'()} | {no_position, streams:'event_store.client.shared.Empty'()} | undefined % oneof
        }).
-endif.
...
-record('event_store.client.shared.UUID',
        {value                  :: {structured, streams:'event_store.client.shared.UUID.Structured'()} | {string, unicode:chardata()} | undefined % oneof
        }).
-endif.
