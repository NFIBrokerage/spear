...
-export_type(['event_store.client.gossip.ClusterInfo'/0, 'event_store.client.gossip.EndPoint'/0, 'event_store.client.gossip.MemberInfo'/0, 'event_store.client.UUID.Structured'/0, 'event_store.client.UUID'/0, 'event_store.client.Empty'/0, 'event_store.client.StreamIdentifier'/0, 'event_store.client.AllStreamPosition'/0, 'event_store.client.WrongExpectedVersion'/0, 'event_store.client.AccessDenied'/0, 'event_store.client.StreamDeleted'/0, 'event_store.client.Timeout'/0, 'event_store.client.Unknown'/0, 'event_store.client.InvalidTransaction'/0, 'event_store.client.MaximumAppendSizeExceeded'/0, 'event_store.client.BadRequest'/0, 'google.protobuf.Empty'/0]).
-type '$msg_name'() :: 'event_store.client.gossip.ClusterInfo' | 'event_store.client.gossip.EndPoint' | 'event_store.client.gossip.MemberInfo' | 'event_store.client.UUID.Structured' | 'event_store.client.UUID' | 'event_store.client.Empty' | 'event_store.client.StreamIdentifier' | 'event_store.client.AllStreamPosition' | 'event_store.client.WrongExpectedVersion' | 'event_store.client.AccessDenied' | 'event_store.client.StreamDeleted' | 'event_store.client.Timeout' | 'event_store.client.Unknown' | 'event_store.client.InvalidTransaction' | 'event_store.client.MaximumAppendSizeExceeded' | 'event_store.client.BadRequest' | 'google.protobuf.Empty'.
-type '$msg'() :: 'event_store.client.gossip.ClusterInfo'() | 'event_store.client.gossip.EndPoint'() | 'event_store.client.gossip.MemberInfo'() | 'event_store.client.UUID.Structured'() | 'event_store.client.UUID'() | 'event_store.client.Empty'() | 'event_store.client.StreamIdentifier'() | 'event_store.client.AllStreamPosition'() | 'event_store.client.WrongExpectedVersion'() | 'event_store.client.AccessDenied'() | 'event_store.client.StreamDeleted'() | 'event_store.client.Timeout'() | 'event_store.client.Unknown'() | 'event_store.client.InvalidTransaction'() | 'event_store.client.MaximumAppendSizeExceeded'() | 'event_store.client.BadRequest'() | 'google.protobuf.Empty'().
...
'merge_msg_event_store.client.gossip.MemberInfo'(#'event_store.client.gossip.MemberInfo'{instance_id = PFinstance_id, time_stamp = PFtime_stamp, state = PFstate, is_alive = PFis_alive, http_end_point = PFhttp_end_point},
    ...
    #'event_store.client.gossip.MemberInfo'{instance_id =
                                                if PFinstance_id /= undefined, NFinstance_id /= undefined -> 'merge_msg_event_store.client.UUID'(PFinstance_id, NFinstance_id, TrUserData);
...
'v_msg_event_store.client.gossip.MemberInfo'(#'event_store.client.gossip.MemberInfo'{instance_id = F1, time_stamp = F2, state = F3, is_alive = F4, http_end_point = F5}, Path, TrUserData) ->
    if F1 == undefined -> ok;
       true -> 'v_msg_event_store.client.UUID'(F1, [instance_id | Path], TrUserData)
    end,
    if F2 == undefined -> ok;
...
get_msg_defs() ->
    [{{enum, 'event_store.client.gossip.MemberInfo.VNodeState'},
     ...
     {{msg, 'event_store.client.gossip.MemberInfo'},
      [#field{name = instance_id, fnum = 1, rnum = 2, type = {msg, 'event_store.client.UUID'}, occurrence = optional, opts = []},
...
get_service_def('event_store.client.gossip.Gossip') ->
    {{service, 'event_store.client.gossip.Gossip'}, [#rpc{name = 'Read', input = 'event_store.client.Empty', output = 'event_store.client.gossip.ClusterInfo', input_stream = false, output_stream = false, opts = []}]};
...
'find_rpc_def_event_store.client.gossip.Gossip'('Read') -> #rpc{name = 'Read', input = 'event_store.client.Empty', output = 'event_store.client.gossip.ClusterInfo', input_stream = false, output_stream = false, opts = []};
...
get_all_source_basenames() -> ["gossip.proto", "shared.proto", "empty.proto"].
...
%% functions.
get_all_proto_names() -> ["gossip", "shared", "empty"].
